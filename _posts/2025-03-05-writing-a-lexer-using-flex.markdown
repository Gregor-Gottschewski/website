...
I created a small cheat sheet over the most important regex expressions as PDF. You can download it [directly](https://raw.githubusercontent.com/Gregor-Gottschewski/Regex-Cheatsheet/refs/heads/main/cheatsheet.pdf) or visit the [GitHub Repository page](https://github.com/Gregor-Gottschewski/Regex-Cheatsheet).
